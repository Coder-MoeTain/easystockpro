...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
  ...
  }), _defineProperty(_objectSpread2, "Download_POS_PDF", function Download_POS_PDF() {
    var _this17 = this;
          ...
          case 3:
            ...
            if (error) {
              ...
              axios.post("pos/create_pos", {
                ...
                tax_rate: _this18.sale.tax_rate ? _this18.sale.tax_rate : 0,
                TaxNet: _this18.sale.TaxNet ? _this18.sale.TaxNet : 0,
                discount: _this18.sale.discount ? _this18.sale.discount : 0,
                shipping: _this18.sale.shipping ? _this18.sale.shipping : 0,
                details: _this18.details,
                GrandTotal: _this18.GrandTotal,
                payment: _this18.payment,
                amount: parseFloat(_this18.payment.amount).toFixed(2),
                received_amount: parseFloat(_this18.payment.received_amount).toFixed(2),
                change: parseFloat(_this18.payment.received_amount - _this18.payment.amount).toFixed(2),
                token: token.id,
    ...
    axios.get("/show_product_data/" + product_id + "/" + variant_id).then(function (response) {
      ...
      _this20.product.product_type = response.data.product_type;
      ...
      _this20.product.product_variant_id = variant_id;
      _this20.product.code = response.data.code;
      _this20.product.fix_price = response.data.fix_price;
      _this20.product.sale_unit_id = response.data.sale_unit_id;
      _this20.product.is_imei = response.data.is_imei;
      _this20.product.imei_number = '';
      _this20.add_product(response.data.code);
      _this20.CaclulTotal();
      // Complete the animation of theprogress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
    });
    ...
    if (this.sale.warehouse_id != "" && this.sale.warehouse_id != null) {
      this.timer = setTimeout(function () {
        var product_filter = _this22.products_pos.filter(function (product) {
          return product.code === _this22.search_input || product.barcode.includes(_this22.search_input);
        });
        if (product_filter.length === 1) {
          _this22.Check_Product_Exist(product_filter[0], product_filter[0].id);
        } else {
          _this22.product_filter = _this22.products_pos.filter(function (product) {
            return product.name.toLowerCase().includes(_this22.search_input.toLowerCase()) || product.code.toLowerCase().includes(_this22.search_input.toLowerCase()) || product.barcode.toLowerCase().includes(_this22.search_input.toLowerCase());
          });
        }
      }, 800);
    } else {
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      _this24.client_name = response.data.default_client_name;
      _this24.getProducts();
      if (response.data.defaultWarehouse != "") {
        _this24.Get_Products_By_Warehouse(response.data.defaultWarehouse);
      }
  ...
  }), _defineProperty(_objectSpread2, "Get_Payment_Methods", function Get_Payment_Methods() {
    var _this25 = this;
    axios.get("get_payment_methods").then(function (response) {
      _this25.payment_methods_options = response.data.map(function (method) {
        return {
          label: method.name,
          value: method.name
        };
  ...
  created: function created() {
    ...
    Fire.$on("pay_now", function () {
      setTimeout(function () {
        ...
        _this26.payment.received_amount = _this26.formatNumber(_this26.GrandTotal, 2);
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_style_index_0_id_4cc49487_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./pos.vue?vue&type=style&index=0&id=4cc49487&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/pos.vue?vue&type=style&index=0&id=4cc49487&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_style_index_0_id_4cc49487_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_8_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_8_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_style_index_0_id_4cc49487_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./pos.vue?vue&type=style&index=0&id=4cc49487&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-8.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/src/views/app/pages/pos.vue?vue&type=style&index=0&id=4cc49487&lang=css&");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_template_id_4cc49487___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_pos_vue_vue_type_template_id_4cc49487___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
