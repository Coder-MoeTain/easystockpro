  ...
  methods: {
    ...
    Get_Payment_Methods: function Get_Payment_Methods() {
      ...
      axios.get("get_payment_methods").then(function (response) {
        _this11.payment_methods_options = response.data.map(function (method) {
          return {
            label: method.name,
            value: method.name
          };
