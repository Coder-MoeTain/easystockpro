...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, (_objectSpread2 = {
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      _this23.client_name = response.data.default_client_name;
      _this23.getProducts();
      if (response.data.defaultWarehouse != "") {
        _this23.Get_Products_By_Warehouse(response.data.defaultWarehouse);
      }
    ...
    axios.get("get_payment_methods").then(function (response) {
      _this24.payment_methods_options = response.data.map(function (method) {
        return {
          label: method.name,
          value: method.name
        };
  ...
  created: function created() {
    ...
    Fire.$on("pay_now", function () {
      setTimeout(function () {
        ...
        _this25.payment.received_amount = _this25.formatNumber(_this25.GrandTotal, 2);
