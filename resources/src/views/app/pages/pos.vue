        ...
        <b-col md="5">
          <b-card no-body class="card-order">
            <div class="main-header">
              ...
              <a @click="SetLocal('mm')">
                <i title="mm" class="flag-icon flag-icon-squared flag-icon-mm"></i>
                <span class="title-lang">Myanmar</span>
              </a>
            ...
            <div style="max-width:400px;margin:0px auto">
              <div class="info">
                <div class="invoice_logo text-center mb-2">
                  <img :src="'/images/'+invoice_pos.setting.logo" alt width="140" height="140">
                </div>
                <p>
