...
export default {
    ...
    Sales: 'ကုန်ရောင်းစာရင်း',
    Purchases: 'ကုန်ဝယ်စာရင်း',
    Returns: 'Return',
    Settings: 'Settings',
    ...
    ProfitandLoss: 'အရှုံးအမြတ်စာရင်း',
    WarehouseStockChart: 'Warehouse Stock Chart',
    SalesReport: 'ကုန်ရောင်းစာရင်း',
    PurchasesReport: 'ကုန်ဝယ်စာရင်း',
    CustomersReport: 'ဝယ်သူ Report',
    SuppliersReport: 'Supplier Report',
    SupplierReport: 'Supplier Report',
    DailySalesData: 'နေ့စဉ်အရောင်းစာရင်း',
    DailyPurchasesData: 'နေ့စဉ်ကုန်ဝယ်စာရင်း',
    ...
    Customer: 'ဝယ်သူ',
    CustomerCode: 'ဝယ်သူကုတ်နံပါတ်',
    Status: 'Status',
    SupplierCode: 'Supplier Code',
    Categorie: 'Category',
    Categories: 'Category',
    StockTransfers: 'ကုန်ပစ္စည်းရွှေ့ခြင်း',
    StockManagement: 'Stock Management',
    dashboard: 'Dashboard',
    Products: 'ကုန်ပစ္စည်းများ',
    productsList: 'ကုန်ပစ္စည်းအားလုံး',
    ProductManagement: 'Product Management',
    ProductQuantityAlerts: 'ကုန်ခါနီးပစ္စည်းစာရင်း',
    CodeProduct: 'Code Product',
    ProductTax: 'Product Tax',
    SubCategorie: 'Sub Category',
    Name_product: 'ကုန်ပစ္စည်းအမည်',
    StockAlert: 'Alert Qty',
    warehouse: 'ဂိုထောင်',
    Tax: 'Tax',
    ...
    CustomerName: 'ဝယ်သူ အမည်',
    CustomerManagement: 'ဝယ်သူ စီမံခန့်ခွဲခြင်း',
    Add: 'Create',
    add: 'Create',
    Edit: 'ပြင်ဆင်မည်',
    Close: 'Close',
    ...
    SelectWarehouse: 'ဂိုထောင်ရွေးချယ်ပါ',
    SelectCustomer: 'ဝယ်သူရွေးချယ်ပါ',
    ...
    EditPurchase: 'ကုန်ဝယ်စာရင်ပြင်ဆင်ခြင်း',
    PurchaseDetail: 'ကုန်ဝယ်အသေးစိတ်',
    AddPurchase: 'ကုန်ဝယ်စာရင်းထည့်သွင်းခြင်း',
    ...
    Addition: 'အရေအတွက်တိုးမည်',
    Subtraction: 'အရေအတွက်လျှော့မည်',
    profil: 'Profile',
    logout: 'Logout',
    ...
    PayeBy: 'Paid By',
    ChooseWarehouse: 'ဂိုဒေါင်ရွေးချယ်ရန်',
    payNow: 'Pay Now',
    ...
    ProductCost: 'ဝယ်ဈေး',
    ProductPrice: 'ရောင်းဈေး',
    UnitProduct: 'ကုန်ပစ္စည်းယူနစ်',
    TaxMethod: 'Tax Type',
    MultipleImage: 'ဓါတ်ပုံထည့်သွင်းရန်',
    ...
    FromWarehouse: 'ပေးပို့သည့်ဂိုထောင်',
    ToWarehouse: 'လက်ခံသည့်ဂိုထောင်',
    ...
    Operator: 'Operator',
    Top5Products: 'ထိပ်ဆုံးကုန်ပစ္စည်း(၅)ခု',
    Last5Sales: 'နောက်ဆုံးအရောင်း(၅)ခု',
    ...
    ListPurchases: 'ကုန်ဝယ်စာရင်းအားလုံး',
    ListSales: 'ကုန်ရောင်းစာရင်းအားလုံး',
    ...
    WarehouseStockChart: 'Warehouse Stock Chart',
    TotalProducts: 'စုစုပေါင်းကုန်ပစ္စည်း',
    TotalQuantity: 'စုစုပေါင်းအရေအတွက်',
    TopCustomers: 'ထိပ်ဆုံး ဝယ်သူ(၅)ဦး',
    ...
    Monday_In:'တနင်္လာနေ့ ရုံးတက်ချိန်',
    Monday_Out:'တနင်္လာနေ့ ရုံးဆင်းချိန်',
    Tuesday_In:'အင်္ဂါနေ့ ရုံးတက်ချိန်',
    tuesday_out:'အင်္ဂါနေ့ ရုံးဆင်းချိန်',
    wednesday_in:'ဗုဒ္ဓဟူးနေ့ ရုံးတက်ချိန်',
    wednesday_out:'ဗုဒ္ဓဟူးနေ့ ရုံးဆင်းချိန်',
    thursday_in:'ကြာသပတေးနေ့ ရုံးတက်ချိန်',
    thursday_out:'ကြာသပတေးနေ့ ရုံးဆင်းချိန်',
    friday_in:'သောကြာနေ့ ရုံးတက်ချိန်',
    friday_out:'သောကြာနေ့ ရုံးဆင်းချိန်',
    saturday_in:'စနေနေ့ ရုံးတက်ချိန်',
    saturday_out:'စနေနေ့ ရုံးဆင်းချိန်',
    sunday_in:'တနင်္ဂနွေနေ့ ရုံးတက်ချိန်',
    sunday_out:'တနင်္ဂနွေနေ့ ရုံးဆင်းချိန်',
    Holiday:'အားလပ်ရက်',
    ...
    Time_In:'Time In',
    Time_Out:'Time Out',
    Choose_Employee:'ဝန်ထမ်းရွေးချယ်ပါ',
    Employee:'ဝန်ထမ်း',
    ...
    Choose_Designation:'ရာထူးရွေးချယ်ခြင်း',
    Designation:'ရာထူး',
    Office_Shift:'Office Shift',
    ...
    Product_Has_Imei_Serial_number:' Imei/Serial Number ပါဝင်သောပစ္စည်း',
    IMEI_SN:'IMEI/SN',
    Shipments:'Shipments',
    ...
    stock_report:'ကုန်လက်ကျန်စာရင်း',
    TotalPurchases:'Total Purchases',
    ...
    pay_all_sell_due_at_a_time:'အကြွေးပေးချေမည်',
    pay_all_sell_return_due_at_a_time:'Sale Return အကြွေးပေးချေမည်',
    ...
    product_report:'ကုန်ပစ္စည်းစာရင်း',
    product_sales_report:'ကုန်ရောင်းအစီရင်ခံစာ',
    Product_purchases_report:'ကုန်ဝယ်အစီရင်ခံစာ',
    Qty_sold:'ရောင်းချပြီးအရေအတွက်',
    Qty_purchased:'ဝယ်ယူပြီးအရေအတွက်',
